...
namespace Core
{
    public class ConnectionSponsorship 
    {
        ...
        public static List<Sponsorships> GetSponsorship(int idUser)
        {
            List<Sponsorships> sponsorship = new List<Sponsorships>();

            try
            {
                for (int i = 0; i < connection.Query<int>($"SELECT * FROM SponsorCommand;").Count(); i++)
                {
                    sponsorship.Add(new Sponsorships
                    {
        ...
        public static List<Sponsorships> GetSponsorshipViewerAdmin()
        {
            List<Sponsorships> sponsorship = new List<Sponsorships>();
